...
<body>
    ...
    <!-- particles js -->
    <script src="{{ asset('/') }}public/new_admin/assets/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="{{ asset('/') }}public/new_admin/assets/js/pages/particles.app.js"></script>
    <!-- password-addon init -->
    <script src="{{ asset('/') }}public/new_admin/assets/js/pages/password-addon.init.js"></script>
</body>
