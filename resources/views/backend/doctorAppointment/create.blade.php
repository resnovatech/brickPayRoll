...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Doctor Appointment</h4>
        ...
        <!-- end page title -->
        <form action="{{ route('doctorAppointments.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
            @csrf
...
>{{ $allPatientList->patient_id }}</option>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" name="appointment_date" class="form-control" id="" placeholder="Name" required>
                                    </div>
                                </div>
