    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ $ins_name }} Dashboard</h4>
                        ...
                        <div class="col-xl-6 col-md-6">
                            ...
                            <div class="card card-animate overflow-hidden">
                                ...
                                <div class="card-body" style="z-index:1 ;">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-semibold text-muted text-truncate mb-3"> Total Collection</p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="card card-animate overflow-hidden">
                                ...
                                <div class="card-body" style="z-index:1 ;">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-semibold text-muted text-truncate mb-3"> Therapist</p>
                        ...
                        <div class="col-xl-6 col-md-6">
                            ...
                            <div class="card card-animate overflow-hidden">
                                ...
                                <div class="card-body" style="z-index:1 ;">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-semibold text-muted text-truncate mb-3">Staff</p>
            ...
            <div class="col-xl-6">
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="#!" class="btn btn-soft-primary btn-sm">All Client List <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div><!-- end card header -->
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <h6 class="mb-0">Dear X</h6>
                                        </div>
                                    </td>
                                    <td>
                                        <i class="ri-map-pin-2-line text-primary me-1 align-bottom"></i> Waiting
                                    </td>
                                    <td>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a href="#!" class="link-secondary">Therapist: Dear X</a>
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
            ...
            <div class="col-xxl-8">
                <div class="card card-height-100">
                    <div class="card-header border-0 align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Applications</h4>
                        <div>
            ...
            <div class="col-xxl-4">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h6 class="card-title mb-0 flex-grow-1">Popular Doctor</h6>
                            <div class="flex-shrink-0">
                ...
                <div class="card overflow-hidden shadow-none border-0">
                    <div class="card-body bg-soft-danger">
                        ...
                        <div class="mt-3 text-end">
                            <a href="#!" class="btn btn-danger">Add New Client</a>
                        </div>
                    </div>
                </div>
            </div><!-- end col -->
        ...
        <div class="row">
            ...
            <div class="col-xxl-4">
                ...
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Our Branch Location</h4>
                        <div class="flex-shrink-0">
                            <button type="button" class="btn btn-soft-primary btn-sm">
                                Export Report
                            </button>
