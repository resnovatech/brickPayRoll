                                        ...
                                        <div class="col-xxl-9">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="card-title">Health Concern</h5>
                                                </div>
                                                <div class="card-body">
                                                    <!-- Swiper -->
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                                                        <a href="#" class="text-dark">{{$allWalkByPatientService->name}}</a>
                                                                    </h5>
                                                                    <p class="text-muted text-truncate mb-0">
                                                                        Details : <span
                                                                                class="fw-semibold text-dark">{{$allWalkByPatientService->detail}}</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            @endforeach
